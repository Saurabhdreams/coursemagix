...
:root {
    ...
    --color-primary-rgb: <?php  rgb(htmlspecialchars($primaryColor)) ?>;
    --color-secondary-rgb: <?php  rgb(htmlspecialchars($secondaryColor)) ?>;
}
:root {
    --main-color:  <?php echo htmlspecialchars($primaryColor);  ?> !important;
    --main-color-shade: <?php echo htmlspecialchars($primaryColor);?> !important;
}
