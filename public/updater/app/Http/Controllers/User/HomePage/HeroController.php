...
class HeroController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if (empty($heroInfo)) {
            ...
            $imageName = NULL;
            if (($themeInfo->theme_version == 3 || $themeInfo->theme_version == 4 || $themeInfo->theme_version == 6) && $request->hasFile('image')) {
                $imageName = Uploader::upload_picture(Constant::WEBSITE_HERO_SECTION_IMAGE, $request->file('image'));
            }
