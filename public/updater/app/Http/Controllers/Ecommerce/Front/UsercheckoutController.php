...
use App\Models\Ecommerce\OfflineGateway;
use App\Http\Helpers\UserPermissionHelper;
use Illuminate\Support\Facades\Session;
use App\Http\Controllers\Ecommerce\Payment\PaytmController;
use App\Http\Controllers\Ecommerce\Payment\MollieController;
use App\Http\Controllers\Ecommerce\Payment\PaypalController;
use App\Http\Controllers\Ecommerce\Payment\StripeController;
use App\Http\Controllers\Ecommerce\Payment\PaystackController;
use App\Http\Controllers\Ecommerce\Payment\RazorpayController;
use App\Http\Controllers\Ecommerce\Payment\InstamojoController;
use App\Http\Controllers\Ecommerce\Payment\FlutterWaveController;
use App\Http\Controllers\Ecommerce\Payment\MercadopagoController;
use App\Http\Controllers\Ecommerce\Payment\AuthorizenetController;
...
class UsercheckoutController extends Controller
{
    ...
    public function checkout($domain, Request $request)
    {
        ...
        $input = $request->all();
        $offline_payment_gateways = UserOfflineGateway::where('user_id', $user->id)->where('status', 1)->pluck('name')->toArray();
        $request['status'] = 1;
        $title = 'Item Checkout';
        $request['mode'] = 'online';
    ...
    public function offlineSuccess()
    {
        ...
        return view('user-front.ecommerce.offline-success');
    }
}
