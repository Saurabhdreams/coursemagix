...
class RegisterUserController extends Controller
{
    ...
    public function secretAdminLogin(Request $request){
    ...
    public function store(Request $request) {
        ...
        if ($user->count() == 0) {
            ...
            //admin Basic Settings time zone
            $adminId = Auth::id();
            $timeZone= Timezone::first();
            $timeZoneId= $timeZone->id;
            $basicSettings = AdminBasicSetting::select('timezone')->first();
            if($basicSettings->timezone != null ){
                //default Time Zone
                $timeZoneId = $basicSettings->timezone;
            }
