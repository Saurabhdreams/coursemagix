                                    ...
                                    <div class="edit-info-area">
                                        <form action="{{ route('customer.update_profile', getParam()) }}" method="POST"
                                            ...
                                            <div class="upload-img">
                                                <div class="img-box">
                                                    <img data-src="{{ is_null($authUser->image) ? asset('assets/tenant/image/customers/profile.jpg') : \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_TENANT_CUSTOMER_IMAGE . '/' . $user->id, $authUser->image, $userBs) }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form_control"
                                                        placeholder="{{ $keywords['contact_number'] ?? __('Contact Number') }}"
