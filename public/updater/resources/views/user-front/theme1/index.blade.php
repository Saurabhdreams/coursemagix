...
@section('content')
    ...
    <section class="banner-area bg_cover lazy"
        @if (!empty($heroInfo)) data-bg="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_HERO_SECTION_IMAGE, $heroInfo->background_image, $userBs) }}"
  @else
    data-bg="{{ asset('assets/tenant/image/static/hero.jpeg') }}" @endif>
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                                    ...
                                    <div class="dream-course-category d-none d-lg-inline-block">
                                        <select name="category">
                                            <option selected disabled>
                                                {{ $keywords['select_category'] ?? __('Select a Category') }}</option>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-11">
                        <div class="section-title text-center">
                            <h3 class="title">
                                {{ !empty($secTitleInfo->category_section_title) ? $secTitleInfo->category_section_title : 'Course Categories' }}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                @if (count($categories) == 0)
                    <div class="row text-center">
                        <div class="col">
                            <h3>{{ $keywords['no_course_category_found'] ?? __('No Course Category Found') }}
                                {{ '!' }}</h3>
                        </div>
                    </div>
                @else
    ...
    @if ($secInfo->call_to_action_section_status == 1)
        <section class="offer-area bg_cover pt-110 pb-120 lazy"
            @if (!empty($callToActionInfo)) data-bg="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ACTION_SECTION_IMAGE, $callToActionInfo->background_image, $userBs) }}" @else data-bg="{{ asset('assets/tenant/image/static/call_to_action.jpeg') }}" @endif>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-11">
                            ...
                            <div class="single-courses mt-30">
                                ...
                                <div class="courses-content">
                                    ...
                                    <div class="courses-info d-flex justify-content-between">
                                        <div class="item">
                                            <img data-src="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_INSTRUCTOR_IMAGE, $course->instructorImage, $userBs) }}"
                                        ...
                                        <div class="price">
                                            @if ($course->pricing_type == 'premium')
                                                <span>{{ $currencyInfo->base_currency_symbol_position == 'left' ? $currencyInfo->base_currency_symbol : '' }}
    ...
    @if ($secInfo->features_section_status == 1)
        ...
        @else
            <section class="features-area gray-bg bg_cover lazy"
                @if (!empty($featureData)) data-bg="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_FEATURE_SECTION_IMAGE, $featureData->features_section_image, $userBs, 'assets/tenant/image/static/features_bg.jpeg') }}" @endif>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="play-thumb">
                            @if (!empty($videoData))
                                <img data-src="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_VIDEO_SECTION_IMAGE, $videoData->image, $userBs) }}"
                                    class="lazy" alt="image">
                                <div class="play-btn">
                                    <a href="{{ $videoData->link }}" class="video-popup"><i class="fas fa-play"></i></a>
                                </div>
                            @else
                                <img data-src="{{ asset('assets/tenant/image/static/intro_video.png') }}" class="lazy"
                                    alt="image">
                                <div class="play-btn">
    ...
    @if ($secInfo->fun_facts_section_status == 1)
        <section class="counter-area bg_cove lazy"
            @if (!empty($factData->background_image)) data-bg="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_FUN_FACT_SECTION_IMAGE, $factData->background_image, $userBs) }}" @else data-bg="{{ asset('assets/tenant/image/static/fun_fact_bg.jpeg') }}" @endif>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title text-center">
    ...
    @if ($secInfo->testimonials_section_status == 1)
        <section class="testimonials-area pb-115 bg_cover lazy"
            @if (!empty($testimonialData->testimonials_section_image)) data-bg="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_TESTIMONIAL_SECTION_IMAGE, $testimonialData->testimonials_section_image, $userBs) }}" @else data-bg="{{ asset('assets/tenant/image/static/testimonial_bg.png') }}" @endif>
            <div class="container">
                        ...
                        @foreach ($testimonials as $testimonial)
                            <div class="col-lg-12">
                                <div class="testimonials-content text-center">
                                    ...
                                    <img data-src="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_TESTIMONIAL_CLIENT_IMAGE, $testimonial->image, $userBs) }}"
        ...
        <section class="community-area">
            ...
            @if (!empty($newsletterData->image))
                <div class="community-thumb d-none d-lg-block">
                    <img data-src="{{ \App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_NEWSLETTER_SECTION_IMAGE, $newsletterData->image, $userBs) }}"
                        class="lazy" alt="image">
                </div>
            @endif
        </section>
