        ...
        <div class="sidebar-content">
            ...
            @if (request()->path() == 'user/dashboard') active @endif">
                ...
                @if (!is_null($package))
                    {{-- Start Instructor --}}
                    <li
                        class="nav-item @if (request()->routeIs('user.instructors')) active
                ...
                @elseif (request()->routeIs('user.instructor.edit_social_link')) active @endif">
                    ...
                    <li
                        class="nav-item @if (request()->routeIs('user.course_management.settings')) active
                ...
                @elseif (request()->routeIs('user.course_management.coupons')) active @endif">
                    ...
                    @elseif (request()->routeIs('user.course_management.coupons')) show @endif">
                            <ul class="nav nav-collapse">
                                ...
                                <li
                                    class="@if (request()->routeIs('user.course_management.courses')) active
                            @elseif (request()->routeIs('user.course_management.create_course')) active
                            @elseif (request()->routeIs('user.course_management.edit_course')) active
                            @elseif (request()->routeIs('user.course_management.course.faqs')) active
                            @elseif (request()->routeIs('user.course_management.course.thanks_page')) active
                ...
                @endif
                {{-- --- Ecommerce  ----- --}}
                @includeIf('user.partials.web_pages')
                {{-- --- Ecommerce  ----- --}}
                @if (!is_null($package))
                    {{-- Registered Users --}}
                    <li
            ...
            @elseif(request()->routeIs('user.user.change_password')) active @endif">
                    ...
                    {{-- home page --}}
                    <li
                        class="nav-item @if (request()->routeIs('user.home_page.hero_section')) active
                ...
                @elseif (request()->routeIs('user.home_page.instructor_section')) active
                ...
                @elseif (request()->routeIs('user.home_page.section_customization')) active @endif">
                    ...
                    @elseif (request()->routeIs('user.home_page.instructor_section')) show
                    ...
                    @elseif (request()->routeIs('user.home_page.section_customization')) show @endif">
                            <ul class="nav nav-collapse">
                                <li class="{{ request()->routeIs('user.home_page.hero_section') ? 'active' : '' }}">
                                    <a
                                        href="{{ route('user.home_page.hero_section', ['language' => $default->code]) }}">
                                        <span class="sub-item">{{ __('Hero Section') }}</span>
                                    </a>
                                </li>
                                <li class="{{ request()->routeIs('user.home_page.section_titles') ? 'active' : '' }}">
                                    <a
                                        href="{{ route('user.home_page.section_titles', ['language' => $default->code]) }}">
                                ...
                                <li
                                    class="{{ request()->routeIs('user.home_page.features_section') ? 'active' : '' }}">
                                    <a
                                        href="{{ route('user.home_page.features_section', ['language' => $default->code]) }}">
                                        <span class="sub-item">

                                            @if ($userBs->theme_version != 6)
                                                {{ __('Features Section') }}
                                            @else
                                                {{ __('Video Section') }}
                                            @endif
                                ...
                                @if ($userBs->theme_version == 1 || $userBs->theme_version == 2 || $userBs->theme_version == 3)
                                    <li
                                        class="{{ request()->routeIs('user.home_page.video_section') ? 'active' : '' }}">
                                        <a
                                            href="{{ route('user.home_page.video_section', ['language' => $default->code]) }}">
                                ...
                                @if ($userBs->theme_version != 5)
                                    <li
                                        class="{{ request()->routeIs('user.home_page.fun_facts_section') ? 'active' : '' }}">
                                        <a
                                            href="{{ route('user.home_page.fun_facts_section', ['language' => $default->code]) }}">
                                            <span class="sub-item">{{ __('Fun Facts Section') }}</span>
                                        </a>
                                    </li>
                                @endif
                                @if ($userBs->theme_version == 4 || $userBs->theme_version == 6)
                                    <li
                                        class="{{ request()->routeIs('user.home_page.instructor_section') ? 'active' : '' }}">
                                        <a
                                            href="{{ route('user.home_page.instructor_section', ['language' => $default->code]) }}">
                                            <span class="sub-item">{{ __('Instructor Section') }}</span>
                                        </a>
                                    </li>
                                @endif
                                <li
                                    ...
                                    <a
                                        href="{{ route('user.home_page.testimonials_section', ['language' => $default->code]) }}">
                                        <span class="sub-item">{{ __('Testimonials Section') }}</span>
                                    </a>
                                </li>
                                <li
                                    class="{{ request()->routeIs('user.home_page.newsletter_section') ? 'active' : '' }}">
                                    <a
                                        href="{{ route('user.home_page.newsletter_section', ['language' => $default->code]) }}">
                                ...
                                @if (
                                    ...
                                    <li
                                        class="{{ request()->routeIs('user.home_page.about_us_section') ? 'active' : '' }}">
                                        <a
                                            href="{{ route('user.home_page.about_us_section', ['language' => $default->code]) }}">
                                ...
                                @if ($userBs->theme_version == 1 || $userBs->theme_version == 2 || $userBs->theme_version == 3)
                                    <li
                                        class="{{ request()->routeIs('user.home_page.course_categories_section') ? 'active' : '' }}">
                ...
                @elseif (request()->routeIs('user.mail.info')) active @endif">
                    ...
                    @elseif (request()->routeIs('user.mail.info')) show @endif"
                            id="basic">
                            <ul class="nav nav-collapse">
