                        ...
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="courseForm" action="{{ route('user.course_management.store_course') }}" method="POST"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label
                                                    for="image"><strong>{{ __('Thumbnail Image')  }}<span class="text-danger">*</span></strong></label>
                                            </div>
                                ...
                                <div class="form-group mt-1">
                                    <label for="">{{ __('Introduction Video')  }}<span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label
                                                    for="image"><strong>{{ __('Cover Image')  }}<span class="text-danger">*</span></strong></label>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <img src="{{ asset('assets/tenant/image/default.jpg') }}" alt="..."
                                ...
                                <div class="form-group mt-1">
                                    <label for="">{{ __('Pricing Type')  }}<span class="text-danger">*</span></label>
                                ...
                                <div class="row" id="">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>{{ __('Duration Time') }} - ({{ __('second') }}) <span class="text-danger">*</span></label>
                                        ...
                                        {{-- <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" placeholder="Enter Total Lessions"
                                                    class="form-control" name="lessions"  required>
                                            </div>
                                        </div> --}}
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div
                                                                ...
                                                                <label for="">{{ __('Instructor')  }}<span class="text-danger">*</span></label>
