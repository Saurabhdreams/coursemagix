                  ...
                  <form id="ajaxForm" action="{{route('user.vcard.store')}}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <label for="">{{__('vCard Name')}} <span class="text-danger">*</span></label>
                     ...
                     <div id="app">
                        ...
                        <div class="row no-gutters" v-for="(information, index) in infromations" :key="information.uniqid">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                   <label for="">{{__('Icon Color')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                   <label for="">{{__('Label')}} <span class="text-danger">*</span></label>
