                        ...
                        <div class="col-lg-8 offset-lg-2">
                            <form id="ajaxForm"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for=""> @if($themeInfo->theme_version == 5) {{ __('Title') }}  @else{{ __('Second Title') }} @endif</label>
                                            <input type="text" class="form-control" name="second_title"
                                                   value="{{ empty($data->second_title) ? '' : $data->second_title }}"
                                                    @if($themeInfo->theme_version == 5) placeholder="Enter Title"  @else placeholder="Enter Second Title" @endif>
