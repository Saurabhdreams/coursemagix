    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header p-1">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{url()->full()}}" class="form-inline d-flex justify-content-between align-items-center">
              ...
              <div class="col-lg-12">
                <form action="{{route('user.orders.export')}}" class="form-inline justify-content-end">
                    <div class="form-group">
                        <button type="submit" class="btn btn-success btn-sm ml-1" title="CSV Format"><i class="fas fa-download"></i> Export</button>
                    </div>
                </form>
              </div>
              @endif
