                                        ...
                                        <div class="version">
                                            ...
                                            <div id="collapse{{ $language->id }}"
                                                ...
                                                <div class="version-body" id="app{{ $language->code }}">
                                                    <div class="row">
                                                        @php
                                                            $categories = App\Models\Ecommerce\UserItemCategory::where('language_id', $language->id)
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div
                                                                ...
                                                                <select data-code="{{ $language->code }}"
                                                                    ...
                                                                    @foreach (App\Models\Ecommerce\UserItemSubCategory::where('language_id', $language->id)->where('user_id', Auth::guard('web')->user()->id)->where('category_id', $postData->category_id ?? '')->get() as $sub)
                                                                        <option
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div
                                                                ...
                                                                <textarea class="form-control" name="{{ $language->code }}_meta_keyword" rows="5"
                                                                    placeholder="{{ __('Enter Meta keyword') }}">{{ is_null($postData) ? '' : $postData->meta_description }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
