                                        ...
                                        <tbody>
                                            @foreach ($items as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- //route('front.user.item_details', ['slug' => $item->slug, Auth::guard('web')->user()->username])  --}}
                                                        <a href=""
                                                            target="_blank">
                                                    ...
                                                    <td>
                                                        <form class="d-inline-block"
                                                            action="{{ route('user.item.status') }}"
                                                            id="statusForm{{ $item->item_id }}" method="POST">
                                                            @csrf
                                                            <input type="hidden" name="item_id"
                                                                value="{{ $item->item_id }}">
                                                            <select name="status" id=""
                                                                class="form-control form-control-sm  @if ($item->status) bg-success @else bg-danger @endif"
                                                                onchange="document.getElementById('statusForm{{ $item->item_id }}').submit();">
                                                                <option value="1"
                                                                    {{ $item->status == 1 ? 'selected' : '' }}>Yes
                                                                </option>
                                                                <option value="0"
                                                                    {{ $item->status == 0 ? 'selected' : '' }}>No
                                                                </option>
                                                            </select>
                                                        </form>
                                                    </td>
