            ...
            <div class="footer-top pt-100 pb-70">
                <div class="container">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <div class="footer-widget" data-aos="fade-up">
                                <h5 class="mb-0">{{ $keywords['latest_post'] ?? __('Latest Post') }}</h5>
                                <div class="row">
                                                ...
                                                <article class="article-item mt-25">
                                                    <div class="image">
                                                        <a href="{{ route('front.user.blog_details', [getParam(), 'slug' => $latestBlogInfo->slug]) }}"
                                                            target="_self"
                                                            title="{{ route('front.user.blog_details', [getParam(), 'slug' => $latestBlogInfo->slug]) }}"
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <h6 class="lc-2 mb-0">
                                                            <a href="{{ route('front.user.blog_details', [getParam(), 'slug' => $latestBlogInfo->slug]) }}"
                                                                target="_self" title="{{ $latestBlogInfo->title }}">
