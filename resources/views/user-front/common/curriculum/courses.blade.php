...
@section('script')
  ...
  <script>
    "use strict";
    var currency_info = @php echo json_encode($currencyInfo) @endphp;
    ...
    var curr_min = {{ !empty(request()->input('min')) ? request()->input('min') : $minPrice }};
    var curr_max = {{ !empty(request()->input('max')) ? request()->input('max') : $maxPrice }};
  </script>
