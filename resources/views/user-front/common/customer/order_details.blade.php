                                                    ...
                                                    <div class="col-lg-4 print-btn">
                                                        ...
                                                        <div class="prinit">
                                                            <a href="{{ asset('assets/front/invoices/' . $data->invoice_number) }}"
                                                                download="invoice.pdf" id="print-click"
                                                                class="btn btn-sm"><i
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach ($data->orderitems as $key => $order)
                                                        @php
                                                            $itemcontent = App\Models\Ecommerce\UserItemContent::where('item_id', $order->item_id)
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if ($order->item->type == 'digital' && $data->payment_status == 'Completed')
                                                                            @if (!empty($order->item->download_file))
                                                                                <form
                                                                                    action="{{ route('user-digital-download', $order->item->id) }}"
                                                                                    method="GET">
                                                                                    @csrf
