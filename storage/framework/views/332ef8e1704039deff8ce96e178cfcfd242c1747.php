            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input type="radio" name="sandbox_check" value="1" class="selectgroup-input" <?php echo e(isset($paypal) && $paypalInfo["sandbox_check"] == 1 ? 'checked' : ''); ?>>
                      <span class="selectgroup-button"><?php echo e(__('Active')); ?></span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="radio" name="sandbox_check" value="0" class="selectgroup-input" <?php echo e(!isset($paypal) || $paypalInfo["sandbox_check"] == 0 ? 'checked' : ''); ?>>
                      <span class="selectgroup-button"><?php echo e(__('Deactive')); ?></span>
                    </label>
                  </div>
                </div>
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input
                        ...
                        <?php echo e(isset($paytm) && $paytmInfo['environment'] == 'local' ? 'checked' : ''); ?>
                    ...
                    <label class="selectgroup-item">
                      <input
                        ...
                        value="production"
                        class="selectgroup-input"
                        <?php echo e(isset($paytm) && $paytmInfo['environment'] == 'production' ? 'checked' : ''); ?>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/gateways/index.blade.php ENDPATH**/ ?>