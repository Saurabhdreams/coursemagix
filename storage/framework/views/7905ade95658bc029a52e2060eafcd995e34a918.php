    ...
    <div class="main">
        <table class="heading">
            <tr>
                <td>
                    <?php if($bs->logo): ?>
                        <img src="<?php echo e(asset('assets/front/img/'.$bs->logo)); ?>" height="40" class="d-inline-block">
                    <?php else: ?>
                        <img src="<?php echo e(asset('assets/admin/img/noimage.jpg')); ?>" height="40" class="d-inline-block">
                    <?php endif; ?>
                </td>
        ...
        <div class="header">
            ...
            <div class="order-details">
                <table class="text-right">
                    ...
                    <tr>
                        <td class="gry-color small"><strong>Package Price:</strong> <?php echo e($membership->package_price == 0 ? "Free": $membership->package_price); ?></td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>Discount:</strong>  -<span class="text-success"><?php echo e($membership->discount); ?></span></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                    ...
                    <tr>
                        <td class="gry-color small"><strong>Order Date:</strong> <?php echo e(\Illuminate\Support\Carbon::now()->format('d/m/Y')); ?></td>
                    </tr>
                </table>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\coursemagix\resources\views/pdf/membership.blade.php ENDPATH**/ ?>