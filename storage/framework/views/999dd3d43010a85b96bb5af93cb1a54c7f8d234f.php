          ...
          <div class="modal-body">
             ...
             <form id="ajaxForm" class="modal-form" action="<?php echo e(route('user.gateway.offline.store')); ?>" method="POST">
                ...
                <div class="form-group">
                   ...
                   <textarea class="form-control summernote" name="instructions" rows="3" cols="80" placeholder="<?php echo e(__('Enter instructions')); ?>" data-height="150"></textarea>
                </div>
...
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/gateways/offline/create.blade.php ENDPATH**/ ?>