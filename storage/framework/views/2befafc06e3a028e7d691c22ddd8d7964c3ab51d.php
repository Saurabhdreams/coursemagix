                                    ...
                                    <div class="selectgroup selectgroup-pills">
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Course Completion Certificate"
                                                class="selectgroup-input" <?php if(is_array($features) && in_array('Course Completion Certificate', $features)): ?> checked <?php endif; ?>>
                                            <span
                                                class="selectgroup-button"><?php echo e(__('Course Completion Certificate')); ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                          <input type="checkbox" name="features[]" value="Ecommerce"
                                              class="selectgroup-input"
                                              <?php if(is_array($features) && in_array('Ecommerce', $features)): ?> checked <?php endif; ?>>
                                          <span class="selectgroup-button"><?php echo e(__('Ecommerce')); ?></span>
                                      </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Coupon"
                                                class="selectgroup-input" <?php if(is_array($features) && in_array('Coupon', $features)): ?> checked <?php endif; ?>>
                                            <span class="selectgroup-button"><?php echo e(__('Coupon')); ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Amazon AWS s3"
                                                class="selectgroup-input" <?php if(is_array($features) && in_array('Amazon AWS s3', $features)): ?> checked <?php endif; ?>>
                                            <span class="selectgroup-button"><?php echo e(__('Amazon AWS s3')); ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Storage Limit"
                                                class="selectgroup-input" <?php if(is_array($features) && in_array('Storage Limit', $features)): ?> checked <?php endif; ?>>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Follow/Unfollow"
                                                class="selectgroup-input" <?php if(is_array($features) && in_array('Follow/Unfollow', $features)): ?> checked <?php endif; ?>>
                                            <span class="selectgroup-button"><?php echo e(__('Follow/Unfollow')); ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Blog"
                                                class="selectgroup-input" <?php if(is_array($features) && in_array('Blog', $features)): ?> checked <?php endif; ?>>
                                            <span class="selectgroup-button"><?php echo e(__('Blog')); ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Advertisement"
                                                class="selectgroup-input"
                                                <?php if(is_array($features) && in_array('Advertisement', $features)): ?> checked <?php endif; ?>>
                                            <span class="selectgroup-button"><?php echo e(__('Advertisement')); ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Custom Page"
                                                class="selectgroup-input"
                                                <?php if(is_array($features) && in_array('Custom Page', $features)): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/admin/packages/features.blade.php ENDPATH**/ ?>