                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-30">
                                        ...
                                        <input id="city" type="text" class="form-control" name="city"
                                               placeholder="<?php echo e(__('City')); ?>" value="<?php echo e(old('city')); ?>"  pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-30">
                                        ...
                                        <input id="district" type="text" class="form-control" name="district"
                                               placeholder="<?php echo e(__('State')); ?>" value="<?php echo e(old('district')); ?>"  pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-30">
                                        ...
                                        <input id="country" type="text" class="form-control" name="country"
                                               placeholder="<?php echo e(__('Country')); ?>" value="<?php echo e(old('country')); ?>" required  pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed">
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coursemagix\resources\views/front/checkout.blade.php ENDPATH**/ ?>