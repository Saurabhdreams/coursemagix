<div class="main-navbar">
    <div class="header-top py-3 mobile-item">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-between gap-15 align-items-center">
                ...
                <div class="social-link style-2 size-md">
                    ...
                    <a class="rounded-pill" href="<?php echo e($socialMediaInfo->url); ?>" target="_blank" title=""><i class="<?php echo e($socialMediaInfo->icon); ?>"></i></a>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                ...
                <?php if(!is_null($websiteInfo->logo)): ?>
                    <a class="navbar-brand" href="<?php echo e(route('front.user.detail.view', getParam())); ?>" target="_self" title="">
                ...
                <div class="collapse navbar-collapse">
                    <ul id="mainMenu" class="navbar-nav mobile-item mx-auto">
                      ...
                      <?php else: ?>
                        <li class="nav-item">
                            <a href="<?php echo e($href); ?>" class="nav-link toggle"> <?php echo e($link["text"]); ?> <i class="fal fa-plus"></i></a>
                            <ul class="menu-dropdown">
                               ...
                               ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e($l2Href); ?>"><?php echo e($level2["text"]); ?></a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </li>
                    ...
                    <div class="item">
                        <div class="language">
                            ...
                            <select class="niceselect" name="lang_code"  onchange="this.form.submit()">
                                ...
                                <option value="<?php echo e($languageInfo->code); ?>" <?php echo e($languageInfo->code == $currentLanguageInfo->code ? 'selected' : ''); ?>><?php echo e($languageInfo->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </form>
                        </div>
                    ...
                    <div class="item">
                     ...
                     <?php endif; ?>
                      ...
                      <?php $authUserInfo = Auth::guard('customer')->user(); ?>
                        <a href="<?php echo e(route('customer.dashboard', getParam())); ?>" class="btn-icon-text" target="_self" title="<?php echo e($keywords['dashboard'] ?? __('Dashboard')); ?>">
                            <i class="fal fa-user"></i> <?php echo e($keywords['dashboard'] ?? __('Dashboard')); ?>
...
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user-front/common/partials/header/header-nav-v4.blade.php ENDPATH**/ ?>