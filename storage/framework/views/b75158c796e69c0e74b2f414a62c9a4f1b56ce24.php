        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 mt-2 mt-lg-0">
              <a class="btn btn-info btn-sm float-right d-inline-block" href="<?php echo e(route('user.announcement_popups', ['language' => $defaultLang->code])); ?>">
    ...
    <div class="row">
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 1])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'1.jpg')); ?>" alt="popup image" width="100%">
      ...
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 2])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'2.jpg')); ?>" alt="popup image" width="100%">
      ...
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 3])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'3.jpg')); ?>" alt="popup image" width="100%">
      ...
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 4])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'4.jpg')); ?>" alt="popup image" width="100%">
      ...
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 5])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'5.jpg')); ?>" alt="popup image" width="100%">
      ...
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 6])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'6.jpg')); ?>" alt="popup image" width="100%">
      ...
      <div class="col-lg-3">
        <a href="<?php echo e(route('user.announcement_popups.create_popup', ['type' => 7])); ?>" class="d-block">
          <div class="card card-stats">
            <div class="card-body">
              <img src="<?php echo e(asset(\App\Constants\Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE.'/'.'7.jpg')); ?>" alt="popup image" width="100%">
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/popup/popup-type.blade.php ENDPATH**/ ?>