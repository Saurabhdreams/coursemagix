    ...
    <?php if($footerSecStatus == 1): ?>
        ...
        <footer class="footer-area bg-primary-light"
            style="background: #<?php echo e($footerInfo->footer_background_color ?? ''); ?> !important">
            <div class="footer-top pt-100 pb-70">
                <div class="container">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <div class="footer-widget" data-aos="fade-up">
                                <h5 class="mb-0"><?php echo e($keywords['latest_post'] ?? __('Latest Posts')); ?></h5>
                                <div class="row">
                                    <?php if(count($latestBlogInfos) == 0): ?>
                                        <div class="alert-secondary mt-4">
                                            <?php echo e($keywords['no_blog_found'] ?? __('No Post Found')); ?>
            ...
            <div class="shape">
                <img class="shape-1 lazyload"
                    src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/placeholder.png')); ?>"
                    data-src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/shape/shape-3.png')); ?>" alt="Shape">
                <img class="shape-2 lazyload"
                    src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/placeholder.png')); ?>"
                    data-src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/shape/shape-1.png')); ?>" alt="Shape">
                <img class="shape-3 lazyload"
                    src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/placeholder.png')); ?>"
                    data-src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/shape/shape-6.png')); ?>" alt="Shape">
                <img class="shape-4 lazyload"
                    src="<?php echo e(asset('assets/front//theme_4_5_6/assets/images/placeholder.png')); ?>"
                    data-src="<?php echo e(asset('assets/front/theme_4_5_6/assets/images/shape/shape-4.png')); ?>" alt="Shape">
            </div>
        </footer>
    <?php endif; ?>
    <!-- Footer-area end-->
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user-front/common/partials/footer/footer-v4.blade.php ENDPATH**/ ?>