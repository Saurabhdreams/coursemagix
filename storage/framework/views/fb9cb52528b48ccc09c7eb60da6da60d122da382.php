...
<div class="page-header">
   <h4 class="page-title"><?php echo e(__('Follower List')); ?></h4>
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="#"><?php echo e(__('Follower Page')); ?></a>
      </li>
      <li class="separator">
         <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
         <a href="#"><?php echo e(__('Followers')); ?></a>
      </li>
   </ul>
</div>
<div class="row">
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="row">
               <div class="col-lg-4">
                  <div class="card-title d-inline-block"><?php echo e(__('Followers')); ?></div>
               </div>
               <div class="col-lg-3">
               </div>
                 ...
                 <?php if(is_null($userDefaultLang)): ?>
                   ...
                   <?php else: ?>
                       <?php if(count($users) == 0): ?>
                           <h3 class="text-center"><?php echo e(__('NO FOLLOWER FOUND')); ?></h3>
                       <?php else: ?>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/follower/index.blade.php ENDPATH**/ ?>