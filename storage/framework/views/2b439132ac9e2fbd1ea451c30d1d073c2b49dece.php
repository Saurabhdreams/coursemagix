  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('user.social.store')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/settings/social-media/create.blade.php ENDPATH**/ ?>