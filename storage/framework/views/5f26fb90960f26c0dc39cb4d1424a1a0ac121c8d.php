...
<script>
  ...
  var imgupload = "<?php echo e(route('user.summernote.upload')); ?>";
  var storeUrl = "";
  var removeUrl = "";
  var rmvdbUrl = "";
...
<!--   Core JS Files   -->
<script src="<?php echo e(asset('assets/admin/js/core/jquery-1.12.4.min.js')); ?>"></script>
...
<!-- jQuery Timepicker -->
<script src="<?php echo e(asset('assets/front/js/jquery.timepicker.min.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('assets/tenant/js/highlight.pack.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/admin/js/custom-ecommerce.js')); ?>"></script>

<?php echo $__env->yieldContent('variables'); ?>
<!-- misc JS -->
<script src="<?php echo e(asset('assets/admin/js/misc.js')); ?>"></script>
<!-- main JS -->
<script src="<?php echo e(asset('assets/tenant/js/main.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/partials/scripts.blade.php ENDPATH**/ ?>