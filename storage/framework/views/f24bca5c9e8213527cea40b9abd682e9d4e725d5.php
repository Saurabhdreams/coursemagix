            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="more-option mobile-item">
                    ...
                    <div class="item">
                        ...
                        <a href="<?php echo e(route('customer.dashboard', getParam())); ?>" class="btn-icon-text" target="_self" aria-label="User" title="<?php echo e(__('Dashboard')); ?>">
...
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user-front/common/partials/header/header-nav-v6.blade.php ENDPATH**/ ?>