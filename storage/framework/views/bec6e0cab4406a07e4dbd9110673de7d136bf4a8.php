        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="<?php echo e(route('user.announcement_popups.select_popup_type')); ?>" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> <?php echo e(__('Add Popup')); ?></a>

              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete" data-href="<?php echo e(route('user.announcement_popups.bulk_delete_popup')); ?>">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $popups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <img src="<?php echo e(\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ANNOUNCEMENT_POPUP_IMAGE,$popup->image,$userBs)); ?>" alt="popup image" width="55">
                          </td>
                          <td><?php echo e(convertUtf8($popup->name)); ?></td>
                          <td>
                            <img src="<?php echo e(\App\Http\Helpers\Uploader::getImageUrl(Constant::WEBSITE_ANNOUNCEMENT_POPUP_SAMPLE_IMAGE,$popup->type.'.jpg',$userBs)); ?>" alt="popup type image" class="pt-4" width="55">
                            <p class="mt-1 text-muted"><?php echo e(__('Type') . ' - ' . $popup->type); ?></p>
                          </td>
                          <td>
                            <form id="statusForm-<?php echo e($popup->id); ?>" class="d-inline-block" action="<?php echo e(route('user.announcement_popups.update_popup_status', ['id' => $popup->id])); ?>" method="post">
                              <?php echo csrf_field(); ?>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1" href="<?php echo e(route('user.announcement_popups.edit_popup', ['id' => $popup->id])); ?>">
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                              </span>
                            </a>

                            <form class="deleteform d-inline-block" action="<?php echo e(route('user.announcement_popups.delete_popup', ['id' => $popup->id])); ?>" method="post">
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/popup/index.blade.php ENDPATH**/ ?>