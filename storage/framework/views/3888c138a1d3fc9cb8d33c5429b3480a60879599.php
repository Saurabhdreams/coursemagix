<div class="main-header">
  ...
  <div class="logo-header" <?php if(request()->cookie('admin-theme') == 'dark'): ?> data-background-color="dark2" <?php endif; ?>>
    ...
    <a href="<?php echo e(route('front.index')); ?>" class="logo" target="_blank">
      <img src="<?php echo e(asset('assets/front/img/'.$bs->logo)); ?>" alt="navbar brand" class="navbar-brand" width="200">
    </a>
...
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/admin/partials/top-navbar.blade.php ENDPATH**/ ?>