  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="<?php echo e(route('user.home_page.store_counter_info', ['language' => request()->input('language')])); ?>" method="post">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            <label for=""><?php echo e(__('Symbol') . '*'); ?></label>
...
<?php /**PATH /var/www/vhosts/coursemagix.com/httpdocs/resources/views/user/home-page/fun-fact-section/create.blade.php ENDPATH**/ ?>