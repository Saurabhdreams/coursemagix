...
class ItemOrderController extends Controller
{
    ...
    public function all(Request $request)
    {
        ...
        return view('user.ecommerce.item.order.index', $data);
    }
    ...
    public function details($id)
    {
        ...
        return view('user.ecommerce.item.order.details', compact('order'));
    }
    ...
    public function report(Request $request)
    {
        ...
        $data['onPms'] = PaymentGateway::where('user_id', Auth::guard('web')->user()->id)->where('status', 1)->get();
        $data['offPms'] = OfflineGateway::where('user_id', Auth::guard('web')->user()->id)->where('status', 1)->get();


        return view('user.ecommerce.item.order.report', $data);
    }
    ...
    public function digitalDownload($itemid = null, Request $request)
    {
