...
use App\Models\Ecommerce\UserCoupon;
...
class ItemController extends Controller
{
    ...
    {
        //if coupon apply and then add product .so coupon remove
    ...
    public function cart($domain)
    {
        ...
        return view('user-front.ecommerce.cart', $data);
    }
    ...
    public function checkout($doamin, Request $request)
    {
        ...
        $data['offlines'] = UserOfflineGateway::where('user_id', $user->id)->where('status', 1)->where('user_id', $user->id)->get();
        ...
        return view('user-front.ecommerce.checkout', $data);
    }
