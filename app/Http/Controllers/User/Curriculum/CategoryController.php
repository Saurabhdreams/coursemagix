...
class CategoryController extends Controller
{
    ...
    public function store(CourseCategoryRequest $request)
    {
        ...
        if($request->hasFile('image')){
            $imageName = Uploader::upload_picture(Constant::WEBSITE_COURSE_CATEGORY_SECTION_IMAGE, $request->file('image'));
        }
        ...
        CourseCategory::create($request->except('language_id','slug','image') + [
