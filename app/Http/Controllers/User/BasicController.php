...
class BasicController extends Controller
{
    ...
    {
		 $rules = [
            'home_meta_keywords' => 'nullable|string|max:35',
            'home_meta_description' => 'nullable|string|max:35',
            'courses_meta_keywords' => 'nullable|string|max:35',
            'courses_meta_description' => 'nullable|string|max:35',
            'instructors_meta_keywords' => 'nullable|string|max:35',
            'instructors_meta_description' => 'nullable|string|max:35',
            'blogs_meta_keywords' => 'nullable|string|max:35',
            'blogs_meta_description' => 'nullable|string|max:35',
            'faqs_meta_keywords' => 'nullable|string|max:35',
            'faqs_meta_description' => 'nullable|string|max:35',
            'contact_meta_keywords' => 'nullable|string|max:35',
            'contact_meta_description' => 'nullable|string|max:35',
            'login_meta_keywords' => 'nullable|string|max:35',
            'login_meta_description' => 'nullable|string|max:35',
            'sign_up_meta_keywords' => 'nullable|string|max:35',
            'sign_up_meta_description' => 'nullable|string|max:35',
            'forget_password_meta_keywords' => 'nullable|string|max:35',
            'forget_password_meta_description' => 'nullable|string|max:35',
        ];
    ...
    public function information()
    {
        ...
        return view('user.settings.information', ['data' => $data,'timezones'=>$timezones]);
    }
    ...
    public function updateInfo(Request $request)
    {
        $request->validate(
            [
                ...
                'contact_number' => 'required|numeric|min:10|max:10',
                'address' => 'required',
