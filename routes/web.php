...
Route::domain($domain)->group(function () {
    ...
    ******************** User Routes **********************
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['auth:web', 'userstatus']], function () {
        ...
        Route::prefix('/shop')->middleware('checkUserPermission:Ecommerce')->group(function () {
            // Category
            Route::get('/category', 'Ecommerce\ItemCategoryController@index')->name('user.itemcategory.index');
            Route::post('/category/store', 'Ecommerce\ItemCategoryController@store')->name('user.itemcategory.store');
            Route::get('/category/{id}/edit', 'Ecommerce\ItemCategoryController@edit')->name('user.itemcategory.edit');
            Route::post('/category/update', 'Ecommerce\ItemCategoryController@update')->name('user.itemcategory.update');
            Route::post('/category/feature', 'Ecommerce\ItemCategoryController@feature')->name('user.itemcategory.feature');
            Route::post('/category/delete', 'Ecommerce\ItemCategoryController@delete')->name('user.itemcategory.delete');
            Route::post('/category/bulk-delete', 'Ecommerce\ItemCategoryController@bulkDelete')->name('user.itemcategory.bulk.delete');
            //    SUbcategory
            Route::get('/subcategory', 'Ecommerce\ItemSubCategoryController@index')->name('user.itemsubcategory.index');
            Route::post('/subcategory/store', 'Ecommerce\ItemSubCategoryController@store')->name('user.itemsubcategory.store');
            Route::get('/subcategory/{id}/edit', 'Ecommerce\ItemSubCategoryController@edit')->name('user.itemsubcategory.edit');
            Route::post('/subcategory/update', 'Ecommerce\ItemSubCategoryController@update')->name('user.itemsubcategory.update');
            Route::post('/subcategory/feature', 'Ecommerce\ItemSubCategoryController@feature')->name('user.itemsubcategory.feature');
            Route::post('/subcategory/delete', 'Ecommerce\ItemSubCategoryController@delete')->name('user.itemsubcategory.delete');
            Route::post('/subcategory/bulk-delete', 'Ecommerce\ItemSubCategoryController@bulkDelete')->name('user.itemsubcategory.bulk.delete');
            // language wise category subcategory insert
            Route::get('/subcategory/get-categories/{id}', 'Ecommerce\ItemSubCategoryController@getCategories');


            Route::get('/shipping', 'Ecommerce\ShopSettingController@index')->name('user.shipping.index');
            Route::post('/shipping/store', 'Ecommerce\ShopSettingController@store')->name('user.shipping.store');
            Route::get('/shipping/{id}/edit', 'Ecommerce\ShopSettingController@edit')->name('user.shipping.edit');
            Route::post('/shipping/update', 'Ecommerce\ShopSettingController@update')->name('user.shipping.update');
            Route::post('/shipping/delete', 'Ecommerce\ShopSettingController@delete')->name('user.shipping.delete');

            Route::get('/item', 'Ecommerce\ItemController@index')->name('user.item.index');
            Route::get('/item/type', 'Ecommerce\ItemController@type')->name('user.item.type');
            Route::get('/item/create', 'Ecommerce\ItemController@create')->name('user.item.create');
            Route::post('/item/store', 'Ecommerce\ItemController@store')->name('user.item.store');
            Route::get('/item/{id}/edit', 'Ecommerce\ItemController@edit')->name('user.item.edit');
            Route::post('/item/update', 'Ecommerce\ItemController@update')->name('user.item.update');
            Route::post('/item/feature', 'Ecommerce\ItemController@feature')->name('user.item.feature');
            Route::post('/item/status', 'Ecommerce\ItemController@status')->name('user.item.status');
            Route::post('/item/special-offer', 'Ecommerce\ItemController@specialOffer')->name('user.item.specialOffer');
            Route::post('/item/delete', 'Ecommerce\ItemController@delete')->name('user.item.delete');
            Route::get('/item/{useritem}/variations', 'Ecommerce\ItemController@variations')->name('user.item.variations');
            Route::post('/item/variation/store', 'Ecommerce\ItemController@variationStore')->name('user.item.variation.store');
            Route::post('/item/flash-remove', 'Ecommerce\ItemController@flashRemove')->name('user.item.flash.remove');
            Route::post('/item/setFlashSale/{id}', 'Ecommerce\ItemController@setFlashSale')->name('user.item.setFlashSale');
            Route::post('/item/slider', 'Ecommerce\ItemController@slider')->name('user.item.slider');
            Route::post('/item/slider/remove', 'Ecommerce\ItemController@sliderRemove')->name('user.item.slider-remove');
            Route::post('/item/db/slider/remove', 'Ecommerce\ItemController@dbSliderRemove')->name('user.item.db-slider-remove');
            Route::post('/item/sub-category-getter', 'Ecommerce\ItemController@subcatGetter')->name('user.item.subcatGetter');

            Route::get('item/{id}/getcategory', 'Ecommerce\ItemController@getCategory')->name('user.item.getcategory');
            Route::post('/item/delete', 'Ecommerce\ItemController@delete')->name('user.item.delete');
            Route::post('/item/bulk-delete', 'Ecommerce\ItemController@bulkDelete')->name('user.item.bulk.delete');
            Route::post('/item/sliderupdate', 'Ecommerce\ItemController@sliderupdate')->name('user.item.sliderupdate');
            Route::get('/item/{id}/variants', 'Ecommerce\ItemController@variants')->name('user.item.variants');
            Route::get('/item/settings', 'Ecommerce\ItemController@settings')->name('user.item.settings');
            Route::post('/item/settings/update', 'Ecommerce\ItemController@updateSettings')->name('user.item.settings.update');
            // User Coupon Routes
            Route::get('/coupon', 'Ecommerce\CouponController@index')->name('user.coupon.index');
            Route::post('/coupon/store', 'Ecommerce\CouponController@store')->name('user.coupon.store');
            Route::get('/coupon/{id}/edit', 'Ecommerce\CouponController@edit')->name('user.coupon.edit');
            Route::post('/coupon/update', 'Ecommerce\CouponController@update')->name('user.coupon.update');
            Route::post('/coupon/delete', 'Ecommerce\CouponController@delete')->name('user.coupon.delete');
            // User Coupon Routes End
            Route::post('/orders/mail', 'Admin\ItemOrderController@mail')->name('user.orders.mail');

            // Product Order
            Route::get('/item/all/orders', 'Ecommerce\ItemOrderController@all')->name('user.all.item.orders');
            Route::get('/item/pending/orders', 'Ecommerce\ItemOrderController@pending')->name('user.pending.item.orders');
            Route::get('/item/processing/orders', 'Ecommerce\ItemOrderController@processing')->name('user.processing.item.orders');
            Route::get('/item/completed/orders', 'Ecommerce\ItemOrderController@completed')->name('user.completed.item.orders');
            Route::get('/item/rejected/orders', 'Ecommerce\ItemOrderController@rejected')->name('user.rejected.item.orders');
            Route::post('/item/orders/status', 'Ecommerce\ItemOrderController@status')->name('user.item.orders.status');
            Route::post('/item/payment/status', 'Ecommerce\ItemOrderController@paymentStatus')->name('user.item.paymentStatus');
            Route::get('/item/orders/details/{id}', 'Ecommerce\ItemOrderController@details')->name('user.item.details');
            Route::post('/item/order/delete', 'Ecommerce\ItemOrderController@orderDelete')->name('user.item.order.delete');
            Route::post('/item/order/bulk-delete', 'Ecommerce\ItemOrderController@bulkOrderDelete')->name('user.item.order.bulk.delete');
            Route::get('/item/orders/report', 'Ecommerce\ItemOrderController@report')->name('user.orders.report');
            Route::get('/item/export/report', 'Ecommerce\ItemOrderController@exportReport')->name('user.orders.export');
            Route::get('/item-download/{itemid}', 'Ecommerce\ItemOrderController@digitalDownload')->name('user-digital-download');
            // Product Order end
        });
        //END SHOP MANAGEMENT
        ...
        Route::prefix('/home-page')->group(function () {
            ...
            //instructor section
            Route::get('/instructor-section', 'User\Teacher\InstructorController@getImageSection')->name('user.home_page.instructor_section');
            Route::post('/update-instructor-section-image', 'User\Teacher\InstructorController@updateImageSection')->name('user.home_page.update_instructor_section_image');
            ...
            //about-us -point
            Route::post('/store-about-us-point', 'User\HomePage\AboutUsController@PointStore')->name('user.home_page.store_about-us-point');
            Route::get('/edit-about-us-point/{id}', 'User\HomePage\AboutUsController@PointEdit')->name('user.home_page.edit_about-us-point');
            Route::post('/update-about-us-point', 'User\HomePage\AboutUsController@PointUpdate')->name('user.home_page.update_about-us-point');
            Route::post('/delete-about-us-point', 'User\HomePage\AboutUsController@PointDelete')->name('user.home_page.delete_about-us-point');
            Route::post('/delete-about-us-point-all', 'User\HomePage\AboutUsController@PointDeleteAll')->name('user.home_page.delete_about-us-point_all');
        ...
        //secret- login for user
        Route::post('register/admin/secret-login', 'User\UserController@secretUserLogin')->name('user.secretUserLogin');
    ...
    ******************** Admin Routes **********************
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus']], function () {
        ...
        Route::group(['middleware' => 'checkpermission:Registered Users'], function () {
            ...
            //secret login
            Route::post('register/admin/secret-login', 'Admin\RegisterUserController@secretAdminLogin')->name('admin.secretAdminLogin');
...
Route::group(['domain' => $domain, 'prefix' => $prefix, 'middleware' => 'userMaintenance'], function () {
    ...
    Route::get('/lazy-load/viwpage/{viewpage}/part/{part?}', 'Front\FrontendController@lazyload')->name('front.lazyload');
    ...
    //Start Ecommerce route
    Route::prefix('/customer')->middleware(['auth:customer', 'accountStatus', 'checkWebsiteOwner', 'routeAccess:Ecommerce'])->group(function () {
        //Customer dashboard
        Route::get('/my-orders', 'Ecommerce\Front\CustomerController@myOrders')->name('customer.my_orders');
        Route::get('/order/{id}', 'Ecommerce\Front\CustomerController@orderdetails')->name('customer.orders-details');
        Route::get('/wishlist', 'Ecommerce\Front\CustomerController@customerWishlist')->name('customer.wishlist');
        Route::get('/remove-from-wishlist/{id}', 'Ecommerce\Front\CustomerController@removefromWish')->name('customer.removefromWish');
        Route::get('/shipping/details', 'Ecommerce\Front\CustomerController@shippingdetails')->name('customer.shpping-details');
        Route::post('/shipping/details/update', 'Ecommerce\Front\CustomerController@shippingupdate')->name('customer.shipping-update');
        Route::get('/billing/details', 'Ecommerce\Front\CustomerController@billingdetails')->name('customer.billing-details');
        Route::post('/billing/details/update', 'Ecommerce\Front\CustomerController@billingupdate')->name('customer.billing-update');
        //Customer dashboard

    });
    Route::group(['middleware' => ['routeAccess:Ecommerce'], 'prefix' => 'shop'], function () {
        Route::get('/', 'Ecommerce\Front\ShopController@shop')->name('front.user.shop');
        Route::get('/item/{slug}', 'Ecommerce\Front\ShopController@adDetails')->name('front.user.item_details');
        Route::post('product/review/submit', 'Ecommerce\Front\ReviewController@reviewsubmit')->name('item.review.submit');
        Route::get('/add-to-cart/{id}', 'Ecommerce\Front\ItemController@addToCart')->name('front.user.add.cart');
        Route::get('/add-to-wishlist/{id}', 'Ecommerce\Front\ItemController@addToWishlist')->name('front.user.add.wishlist');
        Route::get('/cart', 'Ecommerce\Front\ItemController@cart')->name('front.user.cart');
        Route::get('/cart/item/remove/{uid}', 'Ecommerce\Front\ItemController@cartitemremove')->name('front.cart.item.remove');
        Route::post('/cart/update', 'Ecommerce\Front\ItemController@updatecart')->name('front.user.cart.update');
        Route::get('/customer-checkout', 'Ecommerce\Front\ItemController@checkout')->name('front.user.checkout');
        Route::post('/item/payment/submit',   'Ecommerce\Front\UsercheckoutController@checkout')->name('item.payment.submit');
        Route::post('/coupon', 'Ecommerce\Front\ItemController@coupon')->name('front.coupon');
        //success and Error Page
        Route::get('/customer-success', 'Ecommerce\Front\CustomerController@onlineSuccess')->name('customer.success.page');
        Route::get('/payment-error', 'Ecommerce\Front\CustomerController@paymentError')->name('payment.error.page');
        Route::post('/payment/instructions', 'Ecommerce\Front\CustomerController@paymentInstruction')->name('user.front.payment.instructions');

        // CHECKOUT SECTION
        Route::get('/product/payment/return', 'Ecommerce\Payment\PaymentController@payreturn')->name('product.payment.return');
        Route::get('/product/payment/cancle', 'Ecommerce\Payment\PaymentController@paycancle')->name('product.payment.cancle');
        Route::get('/product/paypal/notify',  'Ecommerce\Payment\PaypalController@notify')->name('product.paypal.notify');
        Route::group(['prefix' => 'payments'], function () {
            Route::get('paypal/success', "Ecommerce\Payment\PaypalController@successPayment")->name('customer.itemcheckout.paypal.success');
            Route::get('paypal/cancel', "Ecommerce\Payment\PaypalController@cancelPayment")->name('customer.itemcheckout.paypal.cancel');
            Route::get('stripe/cancel', "Ecommerce\Payment\StripeController@cancelPayment")->name('customer.itemcheckout.stripe.cancel');
            Route::get('paystack/success', 'Ecommerce\Payment\PaystackController@successPayment')->name('customer.itemcheckout.paystack.success');
            Route::any('payment/mercadopago/cancel', 'Ecommerce\Payment\MercadopagoController@cancelPayment')->name('customer.itemcheckout.mercadopago.cancel');
            Route::any('payment/mercadopago/success', 'Ecommerce\Payment\MercadopagoController@successPayment')->name('customer.itemcheckout.mercadopago.success');
            Route::post('razorpay/success', 'Ecommerce\Payment\RazorpayController@successPayment')->name('customer.itemcheckout.razorpay.success');
            Route::post('razorpay/cancel', 'Ecommerce\Payment\RazorpayController@cancelPayment')->name('customer.itemcheckout.razorpay.cancel');
            Route::get('instamojo/success', 'Ecommerce\Payment\InstamojoController@successPayment')->name('customer.itemcheckout.instamojo.success');
            Route::post('instamojo/cancel', 'Ecommerce\Payment\InstamojoController@cancelPayment')->name('customer.itemcheckout.instamojo.cancel');
            Route::post('flutterwave/success', 'Ecommerce\Payment\FlutterWaveController@successPayment')->name('customer.itemcheckout.flutterwave.success');
            Route::any('flutterwave/cancel', 'Ecommerce\Payment\FlutterWaveController@cancelPayment')->name('customer.itemcheckout.flutterwave.cancel');
            Route::get('/mollie/success', 'Ecommerce\Payment\MollieController@successPayment')->name('customer.itemcheckout.mollie.success');
            Route::any('mollie/cancel', 'Ecommerce\Payment\MollieController@cancelPayment')->name('customer.itemcheckout.mollie.cancel');
            Route::get('anet/cancel', 'Ecommerce\Payment\AuthorizenetController@cancelPayment')->name('customer.itemcheckout.anet.cancel');
            Route::get('/offline/success', 'Ecommerce\Front\UsercheckoutController@offlineSuccess')->name('customer.itemcheckout.offline.success');
            Route::get('/trial/success', 'Ecommerce\Front\CheckoutController@trialSuccess')->name('customer.itemcheckout.trial.success');
            Route::post('paytm/payment-status', "Ecommerce\Payment\PaytmController@paymentStatus")->name('customer.itemcheckout.paytm.status');
        });
    });
